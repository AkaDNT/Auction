...
export function AuctionsNavbar() {
  ...
  return (
    <header className="relative z-50 border-b border-theme-line bg-theme-panel/85 backdrop-blur-xl">
      <div className="mx-auto flex h-20 w-full max-w-6xl items-center justify-between px-6">
        <Link href="/auctions" className="group flex items-center gap-3">
